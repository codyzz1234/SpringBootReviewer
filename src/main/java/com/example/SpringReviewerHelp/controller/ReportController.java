...
public class ReportController {
    ...
    @PostMapping(value = "/dynamicPolymorphism/{age}")
    public ResponseEntity<?> testDynamicPolymorphism(@PathVariable("age") int age) {
        return ResponseEntity.status(HttpStatus.OK).body(reportService.dynamicPolymorphism(age));
    }
